...
@section('page_header')
    ...
    <h1 class="page-title">عرض ألانشطه الرياضيه
        <small>عرض جميع ألانشطه الرياضيه</small>
    </h1>
@endsection
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{route('editActivities' , $activity->id)}}">
                                                        <i class="icon-docs"></i> تعديل </a>
                                                </li>

                                                <li>
                                                    <a class="delete_country" data="{{$activity->id}}" data_name="{{$activity->name}}" >
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_country', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/activities/delete/"+id;
