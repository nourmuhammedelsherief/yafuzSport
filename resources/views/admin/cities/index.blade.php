                        ...
                        @foreach($cities as $city)
                            @if($city->parent_id == null)
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo ++$i ?></td>
                                    <td> {{$city->name}} </td>
                                    <td> {{App\Country::whereId($city->country_id)->first()->name}} </td>
                                    <td>
                                        <div class="btn-group">
                                        ...
                                        <li>
                                            <a class="delete_country" data="{{$city->id}}" data_name="{{$city->name}}" >
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_country', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/city/delete/"+id;
                });
