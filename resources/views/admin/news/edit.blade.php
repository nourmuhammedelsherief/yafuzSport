...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/news')}}">ألاخبار لعامة</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>عرض ألاخبار لعامة</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">عرض ألاخبار لعامة
        <small>تعديل جميع ألاخبار لعامة</small>
    </h1>
@endsection
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title" class="form-control" placeholder="عنوان الخبر" value="{{$news->title}}" required>
                                                    @if ($errors->has('title'))
                                                        ...
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                                @if($news->cover_image !==null)
                                                                    <img   src='{{ asset("uploads/cover_images/$news->cover_image") }}'>
                                                                @endif
                                                            </div>
                                                            <div>
                                                            <span class="btn red btn-outline btn-file">
                                                                ...
                                                                <input type="file" name="cover_image" value="{{$news->cover_image}}"> </span>
                                                ...
                                                <div class="col-md-9">
                                                    <select name="city_id" class="form-control" required>
                                                        ...
                                                        @foreach($cities as $city)
                                                            <option value="{{$city->id}}" @if($news->city_id == $city->id) selected @endif> {{$city->name}} </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea type="text" name="details" class="form-control" placeholder=" تفاصيل الخبر" value="{{old('details')}}"> {{$news->details}} </textarea>
