...
@section('page_header')
    ...
    <h1 class="page-title">عرض المجموعات
        <small>اضافة جميع المجموعات</small>
    </h1>
@endsection
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="{{route('storeGroup')}}" enctype="multipart/form-data" >
                <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-anchor font-green-sharp"></i>
                            <span class="caption-subject font-green-sharp bold uppercase">إضافة المجموعه</span>
                        </div>
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea type="text" name="about_me" class="form-control" placeholder="عن المجموعه" value="{{old('about_me')}}"></textarea>
