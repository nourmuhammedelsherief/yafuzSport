...
@section('page_header')
    ...
    <h1 class="page-title">عرض أخبار المجموعات
        <small>تعديل جميع أخبار المجموعات</small>
    </h1>
@endsection
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="{{route('updateGroupNews' , $groupNews->id)}}" enctype="multipart/form-data" >
                <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-anchor font-green-sharp"></i>
                            <span class="caption-subject font-green-sharp bold uppercase">تعديل الاخبار العامه</span>
                        </div>
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title" class="form-control" placeholder="عنوان الخبر" value="{{$groupNews->title}}" required>
                                                    @if ($errors->has('title'))
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                                @if($groupNews->cover_image !==null)
                                                                    <img   src='{{ asset("uploads/cover_images/$groupNews->cover_image") }}'>
                                                                @endif
                                                            </div>
                                                            <div>
                                                ...
                                                <div class="col-md-9">
                                                    <select name="group_id" class="form-control" required>
                                                        ...
                                                        @foreach($groups as $group)
                                                            <option value="{{$group->id}}" @if($groupNews->group_id == $group->id) selected @endif> {{$group->name}} </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-9">
                                                    <select name="city_id" class="form-control" required>
                                                        ...
                                                        @foreach($cities as $city)
                                                            <option value="{{$city->id}}" @if($groupNews->city_id == $city->id) selected @endif> {{$city->name}} </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea type="text" name="details" class="form-control" placeholder=" تفاصيل الخبر" value="{{old('details')}}"> {{$groupNews->details}} </textarea>
