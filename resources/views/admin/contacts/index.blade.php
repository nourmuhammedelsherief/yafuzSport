...
{{--                            <th> الرد </th>--}}
                        ...
                        @foreach($contacts as $contact)
                            <tr class="odd gradeX">
                                ...
                                <td> {{$contact->email}} </td>
                                <td >
                                    <a href="{{ url('admin/contact_us/show', $contact->id) }}">
                                        {{ str_limit($contact->description , 50) }}
                                    </a>
                                </td>
                                <td>
                                    <?php $user = App\User::whereId($contact->user_id)->first(); ?>
                                    @if ($user->posts == '0')
                                         <a class="btn btn-success" href="{{route('AgreeToPost' , $contact->id)}}"> موافقه علي  النشر</a>
                                    @else
                                        تم الموافقه
                                    @endif
                                </td>
